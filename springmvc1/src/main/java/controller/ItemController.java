...
@RequestMapping("item")
public class ItemController { // http://localhost:8088/springmvc1/item
	...
	public ModelAndView list() {
		...
		// itemList : db의 item 테이블의 모든 데이터를 Item 객체들로
		//			  저장하고 있는 객체
	...
	public ModelAndView detail(Integer id) {
		...
		ModelAndView mav = new ModelAndView();
		// item : id에 해당하는 db의 레코드 정보를 한개 저장하고 있는 객체
	...
	/*
	 * @Valid : 유효성 검사(입력값 검증)
	 * item : item 객체의 프로퍼티와 요청파라미터의 이름이 같은 
	...
	/*
	 * RequestMapping : get,post 방식 상관없이 실행
	 * GetMapping : get 방식으로 호출시 실행
	 * @GetMapping("update") : item/update 요청 정보를 get방식으로 호출시
	 */
