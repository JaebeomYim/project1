...
public class Sale {
	...
	public String toString() {
		return "Sale [saleid=" + saleid + ", userid=" + userid + ", saledate=" + saledate + ", user=" + user
				+ ", itemList=" + itemList + ", getTotal()=" + getTotal() + ", getSaleid()=" + getSaleid()
				+ ", getUserid()=" + getUserid() + ", getSaledate()=" + getSaledate() + ", getUser()=" + getUser()
				+ ", getItemList()=" + getItemList() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
