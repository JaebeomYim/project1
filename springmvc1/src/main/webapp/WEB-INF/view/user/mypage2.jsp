...
<script type="text/javascript">
	function disp_div(id,tab) {
		...
		// class="tab"인 태그의 select 클래스 속성을 제거
		$(".tab").removeClass("select")
		$("#"+id).show()	// minfo -> id="minfo"인 태그 보임
							// oinfo -> id="oinfo"인 태그 보임
	...
	<c:forEach items="${salelist}" var="sale" varStatus="stat">
		<tr><td align="center">
			<a href="javascript:list_disp('saleLine${stat.index}')">
				${sale.saleid}</a></td>
			<td align="center">
			<fmt:formatDate value="${sale.saledate}" pattern="yyyy-MM-dd"/></td>
			<td align="right">
