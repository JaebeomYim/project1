  ...
  <div class="w3-row-padding">
        ...
        <div class="w3-container">
          <table>
			<tr><td><a href="update?id=${user.userid}">정보수정</a>&nbsp;</td>
				<td><a href="bookmark?id=${user.userid}">북마크</a>&nbsp;</td>
				<td><a href="myboard?id=${user.userid}">내가 쓴 글</a>&nbsp;</td></tr>
		  </table>
          <hr>
    ...
    <div class="w3-twothird">
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-black w3-padding-16">내가 쓴 글</h2>
      ...
      <div class="w3-container w3-card w3-white">
        <h2 class="w3-text-black w3-padding-16">북마크</h2>
        <div class="w3-third w3-container w3-margin-bottom">
      		<img src="https://health.chosun.com/site/data/img_dir/2022/07/11/2022071101596_0.jpg" alt="사진1"
      			style="width:100%" class="w3-hover-opacity" height="176">
      		<div class="w3-container w3-white">
